...
<?php 
    ...
    if(isset($_GET['id']))
    {
        ...
        $sql2 = "SELECT * FROM food_name WHERE id=$id";
        //execute the Query
        ...
        <table class="tbl-30 table table-borderless table-secondary">
            ...
            <tr>
                <td>
                    ...
                    <input type="submit" name="submit" value="Update Food" class="btn btn-info">
                </td>
            </tr>
            ...
            if(isset($_POST['submit']))
            {
                ...
                if(isset($_FILES['image']['name']))
                {
                    ...
                    if($image_name!="")
                    {
                        ...
                        {
                            //FAiled to Upload
                            $_SESSION['upload'] = "<div class='alert alert-danger'>Failed to Upload new Image.</div>";
                            //REdirect to Manage Food 
                            header('location:'.SITEURL.'admin/manage-food.php');
                            //Stop the Process
                            die();
                        ...
                        if($current_image!="")
                        {
                            ...
                            if($remove==false)
                            {
                                ...
                                $_SESSION['remove-failed'] = "<div class='alert alert-danger'>Faile to remove current image.</div>";
                                //redirect to manage food
                                header('location:'.SITEURL.'admin/manage-food.php');
                                //stop the process
                                die();
